...
export interface TaxonomyStore {
  ...
  assign(item: ExerciseMovementFamily): Promise<void>; removeAssignment(exerciseId: UUID, movementFamilyId: UUID): Promise<void>; familiesForExercise(exerciseId: UUID): Promise<MovementFamily[]>; exercisesForFamily(familyId: UUID): Promise<ExerciseMaster[]>; familiesForMuscle(muscle: string): Promise<MovementFamily[]>;
